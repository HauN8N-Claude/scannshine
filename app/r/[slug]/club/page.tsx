...
export default function Page(props: PageProps<"/r/[slug]/club">) {
  return (
...
async function ClubPage(props: PageProps<"/r/[slug]/club">) {
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-sm flex-1 flex-col justify-center gap-6 py-8">
        ...
        <ContactCapture slug={business.slug} businessName={business.name} />
      </div>
    </main>
  );
}
